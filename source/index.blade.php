        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 pull-right wow fadeInRightBig">
                    <img class="img-responsive " src="/assets/build/img/ipad.png" alt="">
                </div>
                ...
                <div class="col-sm-6 wow fadeInLeftBig">
                     <div id="owl-demo-1" class="owl-carousel">
                        <a href="img/iphone.png" class="image-link">
                            <div class="item">
                                <img  class="img-responsive img-rounded" src="/assets/build/img/iphone.png" alt="">
                            </div>
                        </a>
                        <a href="img/iphone.png" class="image-link">
                            <div class="item">
    ...
    <div class="content-section-a">
        ...
        <div class="container">
             ...
             <div class="row">
                ...
                <div class="col-sm-6 pull-right wow fadeInRightBig">
                    <img class="img-responsive " src="/assets/build/img/doge.png" alt="">
                </div>
            ...
            <div class="row wow bounceInUp" >
              <div id="owl-demo" class="owl-carousel">
                ...
                <a href="img/slide/1.png" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="/assets/build/img/slide/1.png" alt="Owl Image">
                    </div>
                </a>

               <a href="img/slide/2.png" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="/assets/build/img/slide/2.png" alt="Owl Image">
                    </div>
                </a>

                <a href="img/slide/3.png" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="/assets/build/img/slide/3.png" alt="Owl Image">
                    </div>
                </a>
