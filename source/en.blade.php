...
aboutMeBlocks:
  ...
  - title: Cryptographer
    ...
    alt: Cryptography
    lead: Implementation of encryption protocols to secure data during storage or exchanges.<br><small><i>Big Brother...</i>&nbsp;🤫</small>
  ...
  - title: Embedded systems, Home Automation and <abbr title="Machine to Machine">M2M</abbr>
    ...
    alt: Home-Automation
    lead: If I was able to connect my house, based on Arduino, ESP-8266 and Home Assistant, <small>at the price of some frictions with my other half</small>… It means I can do it anywhere else.

  - title: Child of <abbr title="République du Congo">Congo</abbr>
    icon: congo.svg
  ...
  - title: Private Pilot
    ...
    subLead: 28h53 and counting

contactTitle: Contact
contactSubtitle: If the social networks are not enough
contactBtn: Show my e-mail

dedication: To Verone MANKOU, without whom I wouldn't have needed to make this site…
